...
<style>
    ...
    .left-column {
        background-color: #e6e6e6;  /* 옅은 회색 */
    }
    .right-column {
        background-color: #a9a9a9;  /* 짙은 회색 */
    }
    ...
    .stTextArea textarea:focus, .stTextInput input:focus {
        border-color: #0000FF !important;  /* 파란색 */
        box-shadow: 0 0 0 0.2rem rgba(0, 0, 255, 0.25) !important;  /* 파란색 그림자 */
    }
    .stButton > button {
